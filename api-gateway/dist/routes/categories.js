    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, axios_1.default.post(apiUrl + '/categories', req.body)];
            case 1:
                resp = _a.sent();
            ...
            case 2:
                ...
                // Log
                logger.error("POST /categories ERROR:", err_1);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, axios_1.default.get(apiUrl + '/categories')];
            case 1:
                resp = _a.sent();
                res.status(200).json(resp.data);
                // Log
            ...
            case 2:
                ...
                // Log
                logger.error("GET /categories ERROR:", err_2);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
