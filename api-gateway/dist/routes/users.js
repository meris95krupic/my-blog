...
var apiUrl = 'http://localhost:7000/api';
// LOG-Config
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, axios_1.default.put(apiUrl + ("/users/" + req.params.id), req.body)];
            case 1:
                resp = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, axios_1.default.delete(apiUrl + ("/users/" + req.params.id), {
                        data: req.body
                    })];
            case 1:
                resp = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, axios_1.default.get(apiUrl + ("/users/" + req.params.id))];
            case 1:
                resp = _a.sent();
                res.status(200).json(resp.data);
                // Log
            ...
            case 2:
                ...
                // Log
                logger.error('GET /users/:id ERROR:', err_3);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
